...
Si ya has configurado tu primer pendrive de **refugiOS** (ya sea partiendo de la [imagen pregenerada](https://refugios.ganso.org/refugios-base-16G-es.img.zip) o por cualquier otro método) y quieres hacer una copia exacta para un familiar, un amigo o simplemente para tener un respaldo de seguridad, esta guía te explica cómo clonarlo paso a paso.
