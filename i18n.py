...
TRANSLATIONS = {
    'en': {
        ...
        'maps_menu_prompt': 'Do you want to install the Organic Maps module for Offline Cartography and GPS positioning? Estimated size: ~2.1 GB',
        'extras_menu_title': 'OFFICE AND MULTIMEDIA SOFTWARE',
        'extras_menu_prompt': 'Do you want to install the extra software package (LibreOffice, VLC, Syncthing, Evince)? Estimated size: ~1.3 GB',
        'ia_menu_title': 'ARTIFICIAL INTELLIGENCE MODELS (AI)',
        'p2p_menu_title': 'PEER-TO-PEER NETWORK (P2P)',
        'p2p_menu_prompt': 'Prioritize P2P (BitTorrent) downloads over direct downloads? I can be handy on slow or unstable connections, but if you have a fast and reliable connection, direct downloads might be quicker.',
        ...
        'setting_wallpaper': 'Setting the desktop wallpaper...',
        ...
        'installed_apt': '[Installed] {0} via native APT.',
        'installed_appimage': '[Installed] {0} via AppImage.',
        'installed_flatpak': '[Installed] {0} via Flatpak.',
        'installed_recursive_apt': '[Installed] {0} via recursive APT.',
        ...
        'ia_min_label': "Minimum: Use Qwen3-0.6B (~380 MB storage | Requires 4GB RAM)",
        'ia_base_label': "Basic: Use Gemma-4-E4B-it (~4.7 GB storage | Requires 8GB RAM)",
        'ia_med_label': "Intermediate: Use Qwen3-8B analytical model (~4.8 GB storage | Requires 8GB RAM)",
        'ia_max_label': "Maximum: Use Qwen3-14B complex model (~8.6 GB storage | Requires 16GB RAM)",
        'ia_ultra_label': "Ultra: Use Gemma-4-26B-A4B-it maximum model (~16.2 GB storage | Requires 32GB RAM)",
        # Vault management
        ...
        'vault_error_password': "The vault was NOT created. The two passwords did not match, or there was not enough space. Nothing has been lost: try again.",
        ...
        'vault_script_missing': "The vault manager script (refugios-vault.py) could not be located neither in the remote repository nor in the local installation. The cryptographic vault module will be skipped for now, but the rest of the installation will continue. You can re-run the installer later to add it once your connection or repository integrity is restored.",
        'kiwix_script_missing': "The Kiwix launcher script (refugios-kiwix.sh) could not be located neither in the remote repository nor in the local installation. Knowledge base desktop shortcuts will not work until it is available. The rest of the installation will continue. You can re-run the installer later to add it.",
        'ai_script_missing': "The AI assistant launcher script (refugios-ai-selector.sh) could not be located neither in the remote repository nor in the local installation. The AI desktop shortcut will be skipped, but installed models and the rest of the installation are unaffected. You can re-run the installer later to add it.",
    ...
    'es': {
        ...
        'maps_menu_prompt': '¿Deseas instalar el módulo de Organic Maps para Cartografía y posicionamiento GPS Offline? Tamaño estimado: ~2.1 GB',
        'extras_menu_title': 'SOFTWARE OFIMÁTICO Y MULTIMEDIA',
        'extras_menu_prompt': '¿Deseas instalar el paquete de software extra (LibreOffice, VLC, Syncthing, Evince)? Tamaño estimado: ~1.3 GB',
        'ia_menu_title': 'MODELOS DE INTELIGENCIA ARTIFICIAL (IA)',
        'p2p_menu_title': 'RED PEER-TO-PEER (P2P)',
        'p2p_menu_prompt': '¿Priorizar descargas en P2P (BitTorrent) sobre descargas directas? Puede ser útil en conexiones lentas o inestables, pero si tienes una conexión rápida y confiable, las descargas directas podrían ser más rápidas.',
        ...
        'setting_wallpaper': 'Configurando el fondo de escritorio...',
        ...
        'installed_apt': '[Instalado] {0} vía APT nativo.',
        'installed_appimage': '[Instalado] {0} vía AppImage.',
        'installed_flatpak': '[Instalado] {0} vía Flatpak.',
        'installed_recursive_apt': '[Instalado] {0} vía APT recursivo.',
        ...
        'ia_min_label': "Mínimo: Emplear Qwen3-0.6B (~380 MB almacenamiento | Requiere 4GB RAM)",
        'ia_base_label': "Básico: Emplear Gemma-4-E4B-it (~4.7 GB almacenamiento | Requiere 8GB RAM)",
        'ia_med_label': "Intermedio: Emplear modelo analítico Qwen3-8B (~4.8 GB almacenamiento | Requiere 8GB RAM)",
        'ia_max_label': "Máximo: Emplear modelo complejo Qwen3-14B (~8.6 GB almacenamiento | Requiere 16GB RAM)",
        'ia_ultra_label': "Ultra: Emplear modelo máximo Gemma-4-26B-A4B-it (~16.2 GB almacenamiento | Requiere 32GB RAM)",
        # Gestión de bóvedas
        ...
        'vault_error_password': "La bóveda NO se ha creado. Las dos contraseñas no coincidían, o no había espacio suficiente. No se ha perdido nada: inténtalo de nuevo.",
        ...
        'vault_script_missing': "No se pudo localizar el script gestor de bóvedas (refugios-vault.py) ni en el repositorio remoto ni en la instalación local. El módulo de bóvedas criptográficas se omitirá por ahora, pero el resto de la instalación continuará. Puedes volver a ejecutar el instalador más adelante para añadirlo cuando restaures tu conexión o la integridad del repositorio.",
        'kiwix_script_missing': "No se pudo localizar el script lanzador de Kiwix (refugios-kiwix.sh) ni en el repositorio remoto ni en la instalación local. Los accesos directos de las bases de conocimiento no funcionarán hasta que esté disponible. El resto de la instalación continuará. Puedes volver a ejecutar el instalador más adelante para añadirlo.",
        'ai_script_missing': "No se pudo localizar el script lanzador del asistente de IA (refugios-ai-selector.sh) ni en el repositorio remoto ni en la instalación local. Se omitirá el acceso directo de IA, pero los modelos instalados y el resto de la instalación no se ven afectados. Puedes volver a ejecutar el instalador más adelante para añadirlo.",
