...
if [ "$REFUGIOS_LANG" = "en" ]; then
    ...
    WELCOME_BODY_START="Your system has been configured correctly on a device of"
    ...
    WELCOME_BODY_START="Tu sistema se ha configurado correctamente en un dispositivo de"
